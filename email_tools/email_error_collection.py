...
def collect_product_errors(df: pd.DataFrame, products: list[Clothing], col_map, full_list_plu, full_list_barcode, full_supplier_codes):
...
def collect_clothing_errors(df: pd.DataFrame, clothes: list[Clothing], col_map, full_list_style, full_list_barcode, full_supplier_codes):
...
def collect_price_errors(df: pd.DataFrame, prices: list[Product], col_map, full_list_plu, full_supplier_codes):
    cell_flags = {"manual": []}
    manual_summary = []
